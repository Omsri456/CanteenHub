      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-foreground">CanteenHub</h3>
            <p className="text-muted-foreground text-sm">
              Your favorite campus dining experience. Fresh, fast, and delicious meals
              delivered right to your location.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Order Help</a></li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>support@canteenhub.com</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-border mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-muted-foreground">
              © 2024 CanteenHub. All rights reserved.
            </p>
